...
def _(sys):
    sys.argv = [
        "split_lif.py",
        "/Users/jbard/Library/CloudStorage/SynologyDrive-Shared/Data/MaxineC/OMAP:Microscopy results/250820_leica/250820.lif",
        "-o", "/Users/jbard/Library/CloudStorage/SynologyDrive-home/repos/convert_to_ome/test",
        "-n", "DAPI,Cy3,Cy5"
    ]
    return
...
def _():
    ...
    import bioio_lif
    test_file = "/Users/jbard/Library/CloudStorage/SynologyDrive-Shared/Data/MaxineC/OMAP:Microscopy results/250820_leica/250820.lif"
    img = BioImage(test_file, reader=bioio_lif.Reader)
    print(img.scenes)
    print(img.dims)
    print(img.channel_names)
    return BioImage, bioio_lif


@app.cell
def _(BioImage, bioio_lif):
    #!/usr/bin/env python3
    """
...
def _():
    ...
    print("bioio-ome-tiff:", bioio_ome_tiff.__version__)
